          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                ...
                <p className="font-body text-xs text-primary-foreground/60">Children's Online Safety Platform</p>
              </div>
            </div>
            <p className="font-body text-sm text-primary-foreground/70 leading-relaxed max-w-sm">
              An academic IT case study from North Eastern Mindanao State University dedicated to
              advancing children's online safety and data protection across the Philippines.
            </p>
            {/* Emergency banner */}
            <div className="mt-5 inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-2xl px-4 py-3">
              <span className="text-lg">🚨</span>
              <div>
                <p className="font-body text-xs font-bold text-primary-foreground">Emergency Hotline</p>
                <p className="font-body text-sm font-semibold text-accent">MAKABATA 1383</p>
              </div>
            </div>
          </div>
